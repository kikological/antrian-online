    ...
    if (!$username || !$nama || !$role || !in_array($role, ['admin', 'loket'])) {
        ...
        if ($id > 0) {
            ...
            if ($userRole !== 'admin' && $id != $userId) {
                echo "<div style='color: red;'>Akses ditolak.</div>";
            } else {
                if (!empty($password)) {
            ...
            if ($userRole !== 'admin') {
                echo "<div style='color: red;'>Hanya admin yang dapat menambahkan pengguna.</div>";
            } else {
...
if (isset($_GET['hapus'])) {
    ...
    if ($userRole !== 'admin') {
        echo "<div style='color: red;'>Akses ditolak. Hanya admin yang bisa menghapus pengguna.</div>";
    } else {
